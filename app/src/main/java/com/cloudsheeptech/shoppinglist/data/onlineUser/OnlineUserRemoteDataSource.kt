...
@Singleton
class OnlineUserRemoteDataSource
    @Inject
    constructor(
        ...
        suspend fun create(user: ListCreator): Boolean = throw NotImplementedError("this function is not used by the application")
         ...
         */
        @Throws(NotImplementedError::class)
        suspend fun update(updatedUser: ListCreator): Unit = throw NotImplementedError("this function is not used by the application")
         ...
         */
        @Throws(NotImplementedError::class)
        suspend fun delete(userId: Long): Unit = throw NotImplementedError("this function is not used by the application")
    }
