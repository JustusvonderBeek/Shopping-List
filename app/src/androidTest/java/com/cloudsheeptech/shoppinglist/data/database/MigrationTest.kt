    ...
    fun migrate18To21() {
        var db =
            helper.createDatabase(TEST_DB, 18).apply {
                ...
                // user
                execSQL(
                    "INSERT INTO list_table (ID, Name, CreatedBy, CreatedByName, LastEdited) VALUES ('1', 'first list', '1', 'username', '1996-12-19T16:39:57-02:00')",
                )
                execSQL(
                    "INSERT INTO list_table (ID, Name, CreatedBy, CreatedByName, LastEdited) VALUES ('2', 'second list', '1', 'username', '1996-12-19T16:39:57-02:00')",
                )
