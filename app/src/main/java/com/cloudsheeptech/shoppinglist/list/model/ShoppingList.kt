...
import com.cloudsheeptech.shoppinglist.util.OffsetDateTimeUtil
...
data class ShoppingList(
    ...
    override fun toString(): String = "$title ($listId,${createdBy.onlineId}, ${createdBy.username}, Items: $items)"
}
