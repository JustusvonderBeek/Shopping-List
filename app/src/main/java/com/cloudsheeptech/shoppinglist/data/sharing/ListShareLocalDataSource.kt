...
@Singleton
class ListShareLocalDataSource @Inject constructor(
    ...
    suspend fun create(listId: Long, createdBy: Long, sharedWith: Long) {
        withContext(Dispatchers.IO) {
            ...
            val newShare = ListShareDatabase(0L, listId, createdBy, sharedWith)
    ...
    fun readLive(listId: Long, createdBy: Long): LiveData<List<ListShareDatabase>> {
        return shareDao.getListSharedWithLive(listId, createdBy)
    }
